...
in float ao,
in float ior,
in float ansiotropic,
in float ansiotropicrotation,
in float clearcoat,
...
)
{
    ...
    data.misc0.b = ao;
    data.misc0.a = ior;
    data.misc1.r = ansiotropic;
    data.misc1.g = ansiotropicrotation;
	...
	out GeometryAttributes attrs)
{
    ...
    attrs.ao = misc0.b;
    attrs.ior = misc0.a;
    attrs.ansiotropic = misc1.r;
    attrs.ansiotropicrotation = misc1.g;
