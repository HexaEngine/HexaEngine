namespace HexaEngine.Core.Debugging
{
    ...
    /// </summary>
    public unsafe class CPUProfiler2 : ICPUFlameProfiler
    {
        ...
        public static CPUProfiler2 Global { get; } = new();

        /// <summary>
        /// Initializes a new instance of the <see cref="CPUProfiler2"/> class.
        /// </summary>
        public CPUProfiler2()
        {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CPUProfiler2"/> class with a list of predefined stages.
        /// </summary>
        /// <param name="stages">An array of stage names to be pre-created.</param>
        public CPUProfiler2(string[] stages)
        {
            entries.Resize(FrameCount);
            entries.Erase();
            getter = ProfilerValueGetter;
        ...
        {
            private readonly CPUProfiler2 profiler;
            private readonly string name;

            public ProfileBlock(CPUProfiler2 profiler, string name)
            {
