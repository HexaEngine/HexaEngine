...
namespace HexaEngine.Core.Physics.Characters
{
    ...
    public struct StaticCharacterMotionFunctions : IOneBodyConstraintFunctions<StaticCharacterMotionPrestep, CharacterMotionAccumulatedImpulse>
    {
        ...
        private static void ComputeJacobians(in Vector3Wide offsetA, in QuaternionWide basisQuaternion,
    ...
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static void ComputeJacobians(in Vector3Wide offsetA, in Vector3Wide offsetB, in QuaternionWide basisQuaternion,
            out Matrix3x3Wide basis,
