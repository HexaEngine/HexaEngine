namespace HexaEngine.Core.IO.Materials
{
    ...
    public class MaterialFile : MaterialData
    {
        ...
        public MaterialFile(MaterialData material)
        {
        ...
        public MaterialFile(string name, Metadata? metadata = null)
        {
            Name = name;
            Properties = [];
            Textures = [];
        ...
        /// <param name="metadata">The optional metadata associated with the material. If not provided, an empty metadata instance is used.</param>
        public MaterialFile(string name, List<MaterialProperty> properties, List<MaterialTexture> textures, List<MaterialShader> shaders, Metadata? metadata = null)
        {
            Name = name;
