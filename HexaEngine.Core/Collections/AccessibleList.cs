namespace HexaEngine.Core.Collections
{
    ...
    public class AccessibleList<T> : IList<T>, IList, IReadOnlyList<T>
    {
...
#pragma warning restore CA1825
        ...
        // given collection.
        //
        public AccessibleList(IEnumerable<T> collection)
        {
        ...
        public void RemoveRange(int index, int count)
        {
            if (index < 0)
            {
                throw new IndexOutOfRangeException("Index must be larger than or equals to 0");
            }

            if (count < 0)
            {
                throw new IndexOutOfRangeException("Count must be larger than or equals to 0");
            }

            if (_size - index < count)
                throw new IndexOutOfRangeException($"Index and Count is off limits");
        ...
        public void Sort(int index, int count, IComparer<T>? comparer)
        {
            ...
            if (count < 0)
            {
                throw new IndexOutOfRangeException($"Index must be smaller than {count}");
            }
        ...
        public struct Enumerator : IEnumerator<T>, IEnumerator
        {
            ...
            private readonly AccessibleList<T> _list;
            private int _index;
            private readonly int _version;
            private T? _current;

            internal Enumerator(AccessibleList<T> list)
            {
                _list = list;
                _index = 0;
            ...
            {
                AccessibleList<T> localList = _list;
