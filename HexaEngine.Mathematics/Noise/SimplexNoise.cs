namespace HexaEngine.Mathematics.Noise
{
    ...
    public class SimplexNoise
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SimplexNoise"/> class with a specified seed for permutation generation.
        /// </summary>
        /// <param name="seed">The seed value for generating permutations.</param>
        ...
        /// <summary>
        /// Computes the 4D gradient value at a given hash and position.
        /// </summary>
        /// <param name="hash">A hash value used for gradient calculation.</param>
        /// <param name="x">The position on the x-axis.</param>
        /// <param name="y">The position on the y-axis.</param>
        /// <param name="z">The position on the z-axis.</param>
        /// <param name="t">The position on the t-axis.</param>
        /// <returns>The 4D gradient value.</returns>
        public static float Grad(int hash, float x, float y, float z, float t)
        {
        ...
        /// <returns>The simplex noise value in the range [-1, 1].</returns>
        public float Noise(float x)
        {
            ...
            var t0 = 1.0f - x0 * x0;
            t0 *= t0;
            var n0 = t0 * t0 * Grad(p[i0 & 0xff], x0);

            var t1 = 1.0f - x1 * x1;
            t1 *= t1;
            var n1 = t1 * t1 * Grad(p[i1 & 0xff], x1);
