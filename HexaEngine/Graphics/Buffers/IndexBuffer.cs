namespace HexaEngine.Graphics
{
    ...
    public unsafe class IndexBuffer : IBuffer
    {
        ...
        public IndexBuffer(IGraphicsDevice device, CpuAccessFlags flags, [CallerFilePath] string name = "")
        {
            this.device = device;
            this.name = name;
        ...
        public IndexBuffer(IGraphicsDevice device, CpuAccessFlags flags, uint[] indices, [CallerFilePath] string name = "")
        {
            this.device = device;
            this.name = name;
        ...
        public IndexBuffer(IGraphicsDevice device, CpuAccessFlags flags, uint capacity, [CallerFilePath] string name = "")
        {
            this.device = device;
            this.name = name;
