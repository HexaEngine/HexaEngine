...
float3 DirectionalLightCascadedVolumetric(float ditherValue, float3 position, float3 VN, float3 V, Light light, ShadowData shadowData)
{
    ...
    for (int i = 0; i < SAMPLE_COUNT; ++i)
    {
        ...
        float visibility = ShadowFactorDirectionalLightCascaded(shadow_sampler, cascadeShadowMaps, shadowData, x);
