...
#nullable restore
        ...
        public override void Initialize(IGraphicsDevice device, PostFxGraphResourceBuilder creator, int width, int height, ShaderMacro[] macros)
        {
            ...
            downsample = device.CreateGraphicsPipelineState(new GraphicsPipelineDesc()
            {
                ...
                PixelShader = "HexaEngine.PostFx:shaders/effects/bloom/downsample/ps.hlsl",
                Macros = macros
            ...
            {
                VertexShader = "HexaEngine.PostFx:shaders/quad.hlsl",
                PixelShader = "HexaEngine.PostFx:shaders/effects/bloom/upsample/ps.hlsl",
                Macros = macros
            }, GraphicsPipelineStateDesc.DefaultFullscreen);
            ...
            {
                VertexShader = "HexaEngine.PostFx:shaders/quad.hlsl",
                PixelShader = "HexaEngine.PostFx:shaders/effects/bloom/ps.hlsl",
                Macros = [.. shaderMacros]
            }, GraphicsPipelineStateDesc.DefaultFullscreen);
