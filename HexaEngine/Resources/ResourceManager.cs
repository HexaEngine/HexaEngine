...
#nullable enable
        ...
        public static ResourceInstance<MaterialTexture>? LoadTexture(Core.IO.Materials.MaterialTexture desc)
        {
        ...
        public static Task<ResourceInstance<MaterialTexture>?> LoadTextureAsync(Core.IO.Materials.MaterialTexture desc)
        {
        ...
        public static void UpdateTexture(ref ResourceInstance<MaterialTexture>? texture, Core.IO.Materials.MaterialTexture desc)
        {
            string fullname = Paths.CurrentTexturePath + desc.File;
        ...
        public static async Task<ResourceInstance<MaterialTexture>?> UpdateTextureAsync(ResourceInstance<MaterialTexture>? texture, Core.IO.Materials.MaterialTexture desc)
        {
            string fullname = Paths.CurrentTexturePath + desc.File;
            if (texture?.Name == fullname)
            {
