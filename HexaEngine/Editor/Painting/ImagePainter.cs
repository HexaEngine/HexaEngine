namespace HexaEngine.Editor.Painting
{
    ...
    public class ImagePainter : ImGuiWindow
    {
            ...
            if (ImGui.BeginMenuBar())
            {
                if (ImGui.BeginMenu("File"))
                {
                    ...
                    if (ImGui.MenuItem("Export"))
                    {
                        if (source != null)
                        {
                            exporter.Image = device.TextureLoader.CaptureTexture(device, device.Context, source);
                            exporter.Show();
                        }
                    }
        ...
        public void Convert(Format format)
        {
            ...
            try
            {
                var image = device.TextureLoader.CaptureTexture(device, device.Context, source);
