...
#pragma warning restore CS8618 // Non-nullable field 'InMax' must contain a non-null value when exiting constructor. Consider declaring the field as nullable.
        ...
        {
            InValue = AddOrGetPin(new FloatPin(editor.GetUniqueId(), "Value", ImNodesPinShape.QuadFilled, PinKind.Input, mode, 1));
            InMin = AddOrGetPin(new FloatPin(editor.GetUniqueId(), "Min", ImNodesPinShape.QuadFilled, PinKind.Input, mode, 1));
            InMax = AddOrGetPin(new FloatPin(editor.GetUniqueId(), "Max", ImNodesPinShape.QuadFilled, PinKind.Input, mode, 1));
