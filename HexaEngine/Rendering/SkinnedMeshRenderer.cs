namespace HexaEngine.Rendering
{
    ...
    public class SkinnedMeshRenderer : IDisposable
    {
        ...
        public void Draw(IGraphicsContext context)
        {
            ...
            context.VSSetConstantBuffer(offsetBuffer, 0);
            context.VSSetShaderResource(transformBuffer.SRV, 0);
            context.VSSetShaderResource(transformOffsetBuffer.SRV, 1);
            context.VSSetShaderResource(boneTransformBuffer.SRV, 2);
            context.VSSetShaderResource(boneTransformOffsetBuffer.SRV, 3);
            ...
            context.VSSetConstantBuffer(null, 0);
            context.VSSetShaderResource((IShaderResourceView?)null, 0);
            context.VSSetShaderResource((IShaderResourceView?)null, 1);
            context.VSSetShaderResource((IShaderResourceView?)null, 2);
            context.VSSetShaderResource((IShaderResourceView?)null, 3);
        }
