namespace HexaEngine.Rendering.Renderers
{
    ...
    public class ParticleRenderer : IDisposable
    {
        ...
        public unsafe void Emit(IGraphicsContext context, ParticleEmitter emitter)
        {
        ...
        public unsafe void Update(ParticleEmitter emitter)
        {
            var dt = Time.Delta;
        ...
        public void Draw(IGraphicsContext context, ParticleEmitter emitter, IShaderResourceView depthSRV, IShaderResourceView particleSRV)
        {
            ...
            Rasterize(context, emitter, depthSRV, particleSRV);
        }

        public unsafe void Rasterize(IGraphicsContext context, ParticleEmitter emitter, IShaderResourceView depthSRV, IShaderResourceView particleSRV)
        {
            ...
            nint* ps_srvs = stackalloc nint[] { particleSRV.NativePointer, depthSRV.NativePointer };
