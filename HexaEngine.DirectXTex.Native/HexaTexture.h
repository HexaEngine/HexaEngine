...
#pragma region DXGI Format Utilities
    ...
    API bool IsTypeless(_In_ DXGI_FORMAT fmt, _In_ bool partialTypeless = true) noexcept;
...
#pragma region ScratchImageInternal
    ...
    API HRESULT Initialize(DirectX::ScratchImage *img, _In_ const DirectX::TexMetadata &mdata, _In_ DirectX::CP_FLAGS flags = DirectX::CP_FLAGS_NONE) noexcept;

    API HRESULT Initialize1D(DirectX::ScratchImage *img, _In_ DXGI_FORMAT fmt, _In_ size_t length, _In_ size_t arraySize, _In_ size_t mipLevels, _In_ DirectX::CP_FLAGS flags = DirectX::CP_FLAGS_NONE) noexcept;
    API HRESULT Initialize2D(DirectX::ScratchImage *img, _In_ DXGI_FORMAT fmt, _In_ size_t width, _In_ size_t height, _In_ size_t arraySize, _In_ size_t mipLevels, _In_ DirectX::CP_FLAGS flags = DirectX::CP_FLAGS_NONE) noexcept;
    API HRESULT Initialize3D(DirectX::ScratchImage *img, _In_ DXGI_FORMAT fmt, _In_ size_t width, _In_ size_t height, _In_ size_t depth, _In_ size_t mipLevels, _In_ DirectX::CP_FLAGS flags = DirectX::CP_FLAGS_NONE) noexcept;
    API HRESULT InitializeCube(DirectX::ScratchImage *img, _In_ DXGI_FORMAT fmt, _In_ size_t width, _In_ size_t height, _In_ size_t nCubes, _In_ size_t mipLevels, _In_ DirectX::CP_FLAGS flags = DirectX::CP_FLAGS_NONE) noexcept;
...
#pragma region ImageIO
    ...
    // WIC operations
#ifdef WIN32
    API HRESULT LoadFromWICMemory(_In_reads_bytes_(size) const void *pSource, _In_ size_t size, _In_ DirectX::WIC_FLAGS flags, _Out_opt_ DirectX::TexMetadata *metadata, DirectX::ScratchImage *image, _In_opt_ std::function<void(IWICMetadataQueryReader *)> getMQR = nullptr);
    API HRESULT LoadFromWICFile(_In_z_ const wchar_t *szFile, _In_ DirectX::WIC_FLAGS flags, _Out_opt_ DirectX::TexMetadata *metadata, DirectX::ScratchImage *image, _In_opt_ std::function<void(IWICMetadataQueryReader *)> getMQR = nullptr);

    API HRESULT SaveToWICMemory(_In_ const DirectX::Image &image, _In_ DirectX::WIC_FLAGS flags, _In_ REFGUID guidContainerFormat, _Out_ DirectX::Blob &blob, _In_opt_ const GUID *targetFormat = nullptr, _In_opt_ std::function<void(IPropertyBag2 *)> setCustomProps = nullptr);
    API HRESULT SaveToWICMemory2(_In_count_(nimages) const DirectX::Image *images, _In_ size_t nimages, _In_ DirectX::WIC_FLAGS flags, _In_ REFGUID guidContainerFormat, _Out_ DirectX::Blob &blob, _In_opt_ const GUID *targetFormat = nullptr, _In_opt_ std::function<void(IPropertyBag2 *)> setCustomProps = nullptr);

    API HRESULT SaveToWICFile(_In_ const DirectX::Image &image, _In_ DirectX::WIC_FLAGS flags, _In_ REFGUID guidContainerFormat, _In_z_ const wchar_t *szFile, _In_opt_ const GUID *targetFormat = nullptr, _In_opt_ std::function<void(IPropertyBag2 *)> setCustomProps = nullptr);
    API HRESULT SaveToWICFile2(_In_count_(nimages) const DirectX::Image *images, _In_ size_t nimages, _In_ DirectX::WIC_FLAGS flags, _In_ REFGUID guidContainerFormat, _In_z_ const wchar_t *szFile, _In_opt_ const GUID *targetFormat = nullptr, _In_opt_ std::function<void(IPropertyBag2 *)> setCustomProps = nullptr);
#endif // WIN32
