...
namespace ImPlotNET
{
    ...
    public unsafe partial struct ImPlotLimitsPtr
    {
        ...
        public static implicit operator ImPlotLimitsPtr(ImPlotLimits* nativePtr) => new(nativePtr);
        public static implicit operator ImPlotLimits* (ImPlotLimitsPtr wrappedPtr) => wrappedPtr.NativePtr;
        public static implicit operator ImPlotLimitsPtr(IntPtr nativePtr) => new(nativePtr);
        ...
        {
            byte ret = ImPlotNative.ImPlotLimits_ContainsPlotPoInt(NativePtr, p);
            return ret != 0;
        }
        public bool Contains(double x, double y)
        {
            byte ret = ImPlotNative.ImPlotLimits_Containsdouble(NativePtr, x, y);
            return ret != 0;
        }
    }
}
